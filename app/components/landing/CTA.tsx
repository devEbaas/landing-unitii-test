    ...
    <div className="bg-transparent  sm:bg-white">
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        <div
          data-aos="fade-up"
          data-aos-delay="300"
          className="relative isolate overflow-hidden bg-transparent sm:bg-white px-6 pt-16 sm:shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0"
        >
          <svg
